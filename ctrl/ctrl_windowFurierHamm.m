function [plotMass,res_val,f] = ctrl_windowFurierHamm(inputSignal,Fs,sampleSize,degreeOfOverlap)
startSemple=1;
...
[res_val, f]= window_furier(arrayOfPlots,sampleSize,Fs,lenghtSig);
while a <= endIterator
